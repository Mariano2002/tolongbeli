...
headers = {
    ...
    'sec-fetch-mode': 'cors',
    'sec-fetch-dest': 'empty',
    'referer': f'https://www.tokopedia.com/jeantboutique/promo-baju-atasan-kemeja-blouse-valery-wanita-lengan-panjang-murah',
    'accept-language': 'en-US,en;q=0.9',
}
...
while True:
    try:
        ...
        req = requests.get("https://www.tokopedia.com/jeantboutique/promo-baju-atasan-kemeja-blouse-valery-wanita-lengan-panjang-murah", headers=headers,
                           # proxies=proxies,
                           timeout=5)
